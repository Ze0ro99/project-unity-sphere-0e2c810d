...
amount: 3.14,
memo: "Order #9982",
metadata: pirc45*compliant_object, // The object defined in Section 1
}, {
onReadyForServerApproval: (paymentId) => { /* ... _/ },
onReadyForServerCompletion: (paymentId, txid) => { /_ ... _/ },
onCancel: (paymentId) => { /_ ... _/ },
onError: (error, payment) => { /_ ... \_/ },
});
