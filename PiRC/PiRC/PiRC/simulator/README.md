...
📊 Evaluation Criteria
Reviewers should focus on the Reflexive Invariant Output. The simulator is successful if the internal value of REF remains stable despite P\_{market} fluctuations, provided that the \Phi guardrail is active.
