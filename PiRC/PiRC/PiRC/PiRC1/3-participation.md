...
- PiPower for each participant determines the _maximum_ number of tokens they can commit Pi to buy, given the total amount of tokens provided by the project to the Launchpad.
