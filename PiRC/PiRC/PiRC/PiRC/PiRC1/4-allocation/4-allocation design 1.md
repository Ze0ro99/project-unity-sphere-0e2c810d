...
If $t_i^{discount}$ is the amount of tokens a participant $i$ gets due to their Engagement Score, then the _effective_ bottom-line price ($p_{eff,i}$) they pay for the tokens is:
