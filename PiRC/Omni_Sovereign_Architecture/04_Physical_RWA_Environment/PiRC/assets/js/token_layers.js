...
const TOKEN_LAYERS = {
  ...
  thirdEye: {
    // Indigo (refined from Gold for chakra purity)
...
function calculateToPi(amount, layerKey) {
  ...
  if (["heart", "throat"].includes(layerKey))
    return (amount / 10000).toFixed(8);
...
function renderTokenLayerSection() {
  ...
  console.log(
    "%c✅ PiRC-207 v2 Chakra Layers Loaded | Root→Crown hierarchy active",
